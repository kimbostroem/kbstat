...
%% Global options: Explicitly define variable types
% Define model variables and their roles explicitly

options.y = 'reaction_time'; % Dependent variable of model
options.yUnits = 'ms'; % Units of dependent variable
options.x = 'A, B'; % Fixed-effect variables
options.id = 'participant_id'; % Random-effect variable

% %% Alternative: Use link function
% 
